...
Full_ME_model <- glmer(Dom2 ~ PB2+ PB1 + PA + HA + NP + N_A + M + NS + 
...
#### B. ROC ####
roc_score=roc(train_regdata$Dom2, Full_logit_P) #AUC score
...
## Model selection
ME_model_1 <- glmer(Dom2 ~ HA + N_A + M  + (1 | Vaccine_code), 
                       data=train_regdata, family=binomial(link="logit"))                     
...
Fit_ME_model_1 <- glmer(Dom2 ~ HA + N_A + M  +  (1 | Vaccine_code), 
                       data=train_regdata, family=binomial(link="logit"))
...
#### B. ROC ####
roc_score=roc(train_regdata$Dom2, Fit_logit_P) #AUC score
plot(roc_score, col="black",  
     print.auc=TRUE,  
     max.auc.polygon=TRUE,
     print.thres=TRUE, print.thres.pch=19, print.thres.col = "red",
...
ALLHA_ME_model_1 <- glmer(Dom2 ~HA + HA_RBD + HA_15A +  (1 | Vaccine_code), 
                        data=train_regdata, family=binomial(link="logit"))
...
#### B. ROC ####
roc_score=roc(train_regdata$Dom2, AHA_logit_P) #AUC score
plot(roc_score, col="black",  
     print.auc=TRUE,  
     max.auc.polygon=TRUE,
     print.thres=TRUE, print.thres.pch=19, print.thres.col = "red",
...
OnlyHA_ME_model_1 <- glmer(Dom2 ~ HA + (1 | Vaccine_code), 
                          data=train_regdata, family=binomial(link="logit"))
...
#### B. ROC ####
roc_score=roc(train_regdata$Dom2, OHA_logit_P) #AUC score
plot(roc_score, col="black",  
     print.auc=TRUE,  
     max.auc.polygon=TRUE,
     print.thres=TRUE, print.thres.pch=19, print.thres.col = "red",
...
RBD15A_ME_model_1 <- glmer(Dom2 ~ HA_RBD + HA_15A + (1 | Vaccine_code), 
                           data=train_regdata, family=binomial(link="logit"))
...
#### B. ROC ####
roc_score=roc(train_regdata$Dom2, RBD15A_logit_P) #AUC score
plot(roc_score, col="black",  
     print.auc=TRUE,  
     max.auc.polygon=TRUE,
     print.thres=TRUE, print.thres.pch=19, print.thres.col = "red",
...
### 6. RBD model  ###
RBD_ME_model_1 <- glmer(Dom2 ~ HA_RBD  + (1 | Vaccine_code), 
                           data=train_regdata, family=binomial(link="logit"))
...
#### B. ROC ####
roc_score=roc(train_regdata$Dom2, RBD_logit_P) #AUC score
plot(roc_score, col="black",  
     print.auc=TRUE,  
     max.auc.polygon=TRUE,
     print.thres=TRUE, print.thres.pch=19, print.thres.col = "red",
