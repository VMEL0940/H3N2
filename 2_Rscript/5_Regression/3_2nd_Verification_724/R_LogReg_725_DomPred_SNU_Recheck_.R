...
model_set_NS_1  <- dredge(full_model_NS_1)
...
model_set_1 <- dredge(full_model_1)
...
AIC(Base_model_1, Final_model_1, Final_model_1_1, Final_model_1_3, Final_model_1_3_1, Final_model_1_6, Final_model_1_6_1, Final_model_1_1_1)
...
#### B. ROC ####
roc_score_Train_Finalmodel1 <- roc(train_regdata_1$Dom, Final_model_1_logit_P) #AUC score
## 0.7649 ##
...
#### B. ROC ####
roc_score_Train_Finalmodel1_CV <- roc(test_regdata_1$Dom, Final_model_1_logit_P_CV) #AUC score
## 0.8571 ##

#### A. Predicted Score ####
Final_model_1_logit_P = predict(Final_model_1_3_1, newdata = train_regdata_1, type = 'response' )
train_regdata_1$Final_model_1_logit_P <- Final_model_1_logit_P
...
#### A. Predicted Score -- CV ####
Final_model_1_logit_P_CV = predict(Final_model_1_3_1, newdata = test_regdata_1, type = 'response' )
test_regdata_1$Final_model_1_logit_P_CV <- Final_model_1_logit_P_CV
...
## Final selection -- Combine ###
full_model_2 <- glmer(Dom ~ HA_Nonsyn + NA_Nonsyn + PA_Nonsyn + NS_Nonsyn+ PB1_Syn + HA_Syn + NS_Syn + NP_Syn+ (1 | vaccine_code), 
                      data = train_regdata_2, 
                      family = binomial)
...
Final_model_2_1_1 <- glmer(Dom ~ HA_Nonsyn * NA_Nonsyn + NS_Nonsyn * PA_Nonsyn + (1 | vaccine_code), 
                           data = train_regdata_2, 
                           family = binomial) #########
...
Final_model_2_4_1 <- glmer(Dom ~ NA_Nonsyn * NS_Nonsyn + HA_Nonsyn * PA_Nonsyn + (1 | vaccine_code), 
                         data = train_regdata_2, 
                         family = binomial) #########

AIC(Base_model_2, Final_model_2, Final_model_2_1, Final_model_2_1_1, Final_model_2_4, Final_model_2_4_1)
...
## Final selection -- Combine ###
full_model_3 <- glmer(Dom ~ NA_Nonsyn + NS_Nonsyn + PA_Nonsyn + PB2_Nonsyn+ HA_Syn + NP_Syn + NS_Syn + PB1_Syn + (1 | vaccine_code), 
                      data = train_regdata_3, 
                      family = binomial)
...
Final_model_3 <- glmer(Dom ~ NA_Nonsyn + NS_Nonsyn + PA_Nonsyn  +(1 | vaccine_code), 
                       data = train_regdata_3, 
                       family = binomial)

Final_model_3_1 <- glmer(Dom ~ NA_Nonsyn * NS_Nonsyn + PA_Nonsyn + (1 | vaccine_code), 
                         data = train_regdata_3, 
                         family = binomial) #########

Final_model_3_2 <- glmer(Dom ~ NA_Nonsyn + NS_Nonsyn * PA_Nonsyn + (1 | vaccine_code), 
                         data = train_regdata_3, 
                         family = binomial)

Final_model_3_3 <- glmer(Dom ~ HA_Nonsyn * PA_Nonsyn + NS_Nonsyn +  (1 | vaccine_code), 
                         data = train_regdata_3, 
                         family = binomial) 


# Compare models using AIC
AIC(Base_model_3, Final_model_3, Final_model_3_1, Final_model_3_2, Final_model_3_3)
...
## Final selection -- Combine ###
full_model_4 <- glmer(Dom ~ HA_Nonsyn + NA_Nonsyn + NS_Nonsyn + NP_Nonsyn + PA_Nonsyn + HA_Syn + M_Syn + NP_Syn + PB1_Syn + (1 | vaccine_code), 
                      data = train_regdata_4, 
                      family = binomial)
...
Final_model_4 <- glmer(Dom ~ NA_Nonsyn + NS_Nonsyn + PA_Nonsyn +(1 | vaccine_code), 
                       data = train_regdata_4, 
                       family = binomial)

Final_model_4_1 <- glmer(Dom ~ NA_Nonsyn * NS_Nonsyn + PA_Nonsyn + (1 | vaccine_code), 
                         data = train_regdata_4, 
                         family = binomial) #########

Final_model_4_2 <- glmer(Dom ~ NA_Nonsyn + NS_Nonsyn * PA_Nonsyn + (1 | vaccine_code), 
                         data = train_regdata_4, 
                         family = binomial)

Final_model_4_4 <- glmer(Dom ~ HA_Nonsyn * PA_Nonsyn + NS_Nonsyn +  (1 | vaccine_code), 
                         data = train_regdata_4, 
                         family = binomial) 


# Compare models using AIC
AIC(Base_model_4, Final_model_4, Final_model_4_1, Final_model_4_2, Final_model_4_4)
