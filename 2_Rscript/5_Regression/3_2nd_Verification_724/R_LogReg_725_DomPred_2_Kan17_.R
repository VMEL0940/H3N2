...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_2_Kan17/2_Kan_HA_NANS_Train.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
plot(roc_score_Train_HA_NANS, col="black",  
     ...
     main ="ROC curve of the 2.Kan17 Model for Train set")
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_2_Kan17/2_Kan_HA_NANS_Test.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
plot(roc_score_Test_HA_NANS, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="ROC curve of the 2.Kan17 Model for Test set")
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_2_Kan17/2_Kan_HA_Train.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
plot(roc_score_Train_HA, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="ROC curve of the 2.Kan17 Base Model for Train set")
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_2_Kan17/2_Kan_HA_Test.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
plot(roc_score_Test_HA, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="ROC curve of the 2.Kan17 Base Model for Test set")
