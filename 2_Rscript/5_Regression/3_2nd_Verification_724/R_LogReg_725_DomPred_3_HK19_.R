...
##### 2.3 NA + PA  model ##### ---  Significant
GD_2_3_NA_PA_model <- glmer(Dom ~ N_A + PA + (1 | vaccine_code), 
                            data=train_regdata, family=binomial(link="logit"))    

summary(GD_2_3_NA_PA_model)
AIC(GD_2_3_NA_PA_model)


##### 2.3.1 NA * PA  model ##### ---  Significant
GD_2_3_1_NAPA_model <- glmer(Dom ~ N_A * PA + (1 | vaccine_code), 
                            data=train_regdata, family=binomial(link="logit"))    

summary(GD_2_3_1_NAPA_model)
AIC(GD_2_3_1_NAPA_model)


##### 2.4 NA + NS  model ##### ---  Significant
GD_2_4_NA_NS_model <- glmer(Dom ~ N_A + NS + (1 | vaccine_code), 
                            data=train_regdata, family=binomial(link="logit"))    

summary(GD_2_4_NA_NS_model)
AIC(GD_2_4_NA_NS_model)

##### 2.4.1 NA * NS  model ##### ---  Significant
GD_2_4_1_NANS_model <- glmer(Dom ~ N_A * NS + (1 | vaccine_code), 
                            data=train_regdata, family=binomial(link="logit"))    

summary(GD_2_4_1_NANS_model)
AIC(GD_2_4_1_NANS_model)


##### 3.1 NA * NS + PA model ##### ---  No Significant
GD_3_1_NANS_PA_model <- glmer(Dom ~ N_A*NS + PA + (1 | vaccine_code), 
                               data=train_regdata, family=binomial(link="logit"))    

summary(GD_3_1_NANS_PA_model)
AIC(GD_3_1_NANS_PA_model)
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_3_HK19/3_HK19_NANS_PA_Train.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
plot(roc_score_Train_NANS_PA, col="black",  
     ...
     main ="ROC curve of the 3.HK19 Model for Train set")
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_3_HK19/3_HK19_NANS_PA_Test.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
plot(roc_score_Test_NANS_PA, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="ROC curve of the 3.HK19 Model for Test set")
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_3_HK19/3_HK19_HA_Train.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
plot(roc_score_Train_HA, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="ROC curve of the 3.HK19 Base Model for Train set")
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_3_HK19/3_HK19_HA_Test.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
plot(roc_score_Test_HA, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="ROC curve of the 3.HK19 Base Model for Test set")
