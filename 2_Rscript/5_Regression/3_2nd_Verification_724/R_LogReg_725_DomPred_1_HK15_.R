...
##### 2.1.1 HA X NA  model #####  --- No Significant
...
##### 2.2 HA + PA  model ##### ---  No Significant
...
##### 2.3 HA + NS  model ##### ---  No Significant
...
##### 3.1 HA + NA + PA model ##### ---  No Significant
...
##### 3.2 HA + NA + NS model ##### ---  Significant
...
##### 3.2.1 HA*NS + NA model ##### ---  Significant
GD_3_2_1_HANS_NA_model <- glmer(Dom ~ HA*NS + N_A + (1 | vaccine_code), 
                               data=train_regdata, family=binomial(link="logit"))    

summary(GD_3_2_1_HANS_NA_model)
AIC(GD_3_2_1_HANS_NA_model)

##### 3.2.2 HA + NA*NS model ##### ---  Significant
...
##### 4.1.1 HA*PA + NA*NS  model ##### ---  No Significant
GD_4_1_1_HAPA_NANS_model <- glmer(Dom ~ HA*PA + N_A*NS  +(1 | vaccine_code), 
                                 data=train_regdata, family=binomial(link="logit"))    

summary(GD_4_1_1_HAPA_NANS_model)
AIC(GD_4_1_1_HAPA_NANS_model)
...
#jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_1_HK15/1_HK15_HA_NANS_Train.jpeg", width = 170, height = 150, units = "mm", res = 520)
svg(filename = "01_GenDisFlu/Fig/PredModel/725_1_HK15/1_HK15_HA_NANS_Train.svg", width = 17, height = 15)
...
plot(roc_score_Train_HA_NANS, col="black",  
     ...
     main ="ROC curve of the 1.HK15 Model for Train set")
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_1_HK15/1_HK15_HA_NANS_Test.jpeg", width = 170, height = 150, units = "mm", res = 520)

plot(roc_score_Test_HA_NANS, col="black",  
     print.auc=TRUE,  
     max.auc.polygon=TRUE, print.auc.cex= 1.5,
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="ROC curve of the 1. HK15 Model for Test set")
...
#jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_1_HK15/1_HK15_HA_Train.jpeg", width = 170, height = 150, units = "mm", res = 520)
svg(filename = "01_GenDisFlu/Fig/PredModel/725_1_HK15/1_HK15_HA_Train.svg", width = 17, height = 15)
...
plot(roc_score_Train_HA, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="ROC curve of the 1.HK15 Base Model for Train set")
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/725_1_HK15/1_HK15_HA_Test.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
plot(roc_score_Test_HA, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="ROC curve of the 1. HK15 Base Model for Test set")
