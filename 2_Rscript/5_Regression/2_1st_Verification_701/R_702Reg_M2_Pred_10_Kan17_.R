...
####### Preset for Prediction of 10. Kan17 ###########
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/2_Kan17Model/1_HA_Model.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/2_Kan17Model/1_HA_Model_CV.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
lrtest(GD_1_HA_model, GD_2_3_HA_NS_model) ## Significant -- Yes
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/2_Kan17Model/2_2_HA_NA_Model.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/2_Kan17Model/2_2_HA_NA_Model_CV.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
lrtest(GD_2_2_HA_NA_model, GD_3_1_HA_NA_PA_model) ## Significant -- Yes
AIC(GD_3_1_HA_NA_PA_model)


#### 3.1 HA + NA + PA Model #####
GD_3_1_A_NA_PA_model <- glmer(Dom ~ N_A + PA + (1 | vaccine_code), 
                               data=train_regdata, family=binomial(link="logit"))    ### No interaction!

summary(GD_3_1_A_NA_PA_model)
AIC(GD_3_1_A_NA_PA_model)
lrtest(GD_2_2_HA_NA_model, GD_3_1_HA_NA_PA_model) ## Significant -- Yes
...
lrtest(GD_2_2_HA_NA_model, GD_3_1_1_HAPA_NA_model) ## Non - Significant
...
lrtest(GD_2_2_HA_NA_model, GD_3_1_2_HA_NAPA_model) ## Non - Significant
...
### TRAINING ROC ##
#### A. Predicted Score ####
HA_NANS_logit_P = predict(GD_3_1_HA_NA_PA_model, newdata = train_regdata, type = 'response' )
train_regdata$HA_NANS_logit_P <- HA_NANS_logit_P

#### B. ROC ####
roc_score_3_1_HA_NA_PA <- roc(train_regdata$Dom, HA_NANS_logit_P) #AUC score

jpeg(filename = "01_GenDisFlu/Fig/PredModel/2_Kan17Model/3_1_HA_NA_PA_Model.jpeg", width = 170, height = 150, units = "mm", res = 520)

plot(roc_score_3_1_HA_NA_PA, col="black",  
     print.auc=TRUE,  
     max.auc.polygon=TRUE, print.auc.cex= 1.5,
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
...
#### A. Predicted Score ####
HA_NA_PA_logit_P_CV = predict(GD_3_1_HA_NA_PA_model, newdata = test_regdata, type = 'response' )
test_regdata$HA_NA_PA_logit_P_CV <- HA_NA_PA_logit_P_CV

#### B. ROC ####
roc_score_3_1_HA_NA_PA_CV <- roc(test_regdata$Dom, HA_NA_PA_logit_P_CV) #AUC score

jpeg(filename = "01_GenDisFlu/Fig/PredModel/2_Kan17Model/3_1_HA_NA_PA_Model_CV.jpeg", width = 170, height = 150, units = "mm", res = 520)

plot(roc_score_3_1_HA_NA_PA_CV, col="black",  
     print.auc=TRUE,  
     max.auc.polygon=TRUE, print.auc.cex= 1.5,
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
...
GD_4_1_HA_NA_PA_NS_model <- glmer(Dom ~ HA + N_A + PA + NS + (1 | vaccine_code), 
                               data=train_regdata, family=binomial(link="logit"))    ### No interaction!

summary(GD_4_1_HA_NA_PA_NS_model)

lrtest(GD_3_1_HA_NA_PA_model, GD_4_1_HA_NA_PA_NS_model) ## Non - Significant -- NO


#### 4.2 HA*NS + NA + PA Model #####
GD_4_2_HANS_NA_PA_model <- glmer(Dom ~ HA*NS + N_A + PA + (1 | vaccine_code), 
                                data=train_regdata, family=binomial(link="logit"))    ### No interaction!

summary(GD_4_2_HANS_NA_PA_model)

lrtest(GD_3_1_HA_NA_PA_model, GD_4_2_HANS_NA_PA_model) ## Non - Significant -- NO


#### 4.3 HA + NA*NS + PA Model #####
GD_4_3_HA_NANS_PA_model <- glmer(Dom ~ HA + N_A*NS + PA + (1 | vaccine_code), 
                                 data=train_regdata, family=binomial(link="logit"))    ### No interaction!

summary(GD_4_3_HA_NANS_PA_model)

lrtest(GD_3_1_HA_NA_PA_model, GD_4_3_HA_NANS_PA_model) ## Non - Significant -- NO


#### 4.4 HA + NA + PA*NS Model #####
GD_4_4_HA_NA_PANS_model <- glmer(Dom ~ HA + N_A + PA*NS + (1 | vaccine_code), 
                                 data=train_regdata, family=binomial(link="logit"))    ### No interaction!

summary(GD_4_4_HA_NA_PANS_model)

lrtest(GD_3_1_HA_NA_PA_model, GD_4_4_HA_NA_PANS_model) ## Non - Significant -- NO
