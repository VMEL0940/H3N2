...
#### 3.1 HA * PA + NA Model #####
GD_3_1_HAPA_NA_model <- glmer(Dom ~ HA * PA + N_A + (1 | vaccine_code), 
                              data=train_regdata, family=binomial(link="logit"))    ### No interaction!

summary(GD_3_1_HAPA_NA_model)

lrtest(GD_2_2_1_HANA_model, GD_3_1_HANA_PA_model)


#### 3.2 HA + NA * NS Model #####
GD_3_2_HA_NANS_model <- glmer(Dom ~ HA + N_A * NS + (1 | vaccine_code), 
                              data=train_regdata, family=binomial(link="logit"))    ### No interaction!

summary(GD_3_2_HA_NANS_model)

lrtest(GD_2_2_HA_NA_model, GD_3_2_HA_NANS_model)
