...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/3_HK19Model/1_HA_Model.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/3_HK19Model/1_HA_Model_CV.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
lrtest(GD_1_HA_model, GD_2_3_HA_NS_model) ## Non-Significant
...
lrtest(GD_1_HA_model, GD_2_3_1_HANS_model) ## Non-Significant
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/3_HK19Model/2_HANA_Model.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/3_HK19Model/2_1_HANA_Model_CV.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/3_HK19Model/3_1_HANA_PA_Model.jpeg", width = 170, height = 150, units = "mm", res = 520)
...
jpeg(filename = "01_GenDisFlu/Fig/PredModel/3_HK19Model/3_1_HANA_PA_Model_CV.jpeg", width = 170, height = 150, units = "mm", res = 520)
