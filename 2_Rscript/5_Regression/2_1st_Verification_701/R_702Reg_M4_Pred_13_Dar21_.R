...
plot(roc_score_1_HA_CV, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="1.1. ROC curve of the HA GD Model - CV")
...
plot(roc_score_2_2_HA_NA_CV, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="2.2. ROC curve of the HA * NA GD Model - CV")
...
plot(roc_score_3_1_HANA_PA, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="3.1 ROC curve of the HA * NA+PA GD Model")
...
plot(roc_score_3_1_HANA_PA_CV, col="black",  
     ...
     print.thres=TRUE, print.thres.pch=21, print.thres.col = "red",
     auc.polygon=TRUE, auc.polygon.col="#f8ce1c", 
     main ="3.1 ROC curve of the HA * NA+PA GD Model - CV")
