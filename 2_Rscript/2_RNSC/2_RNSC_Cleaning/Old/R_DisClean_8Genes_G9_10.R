...
## Data import ##
HA_G9 <- read.table("Data/Genetic Distances/HA distances/HA_G9_distances.txt", header = T)
...
for (i in 1:nrow(HA_G9))
  {Nnse$value[i] <- HA_G9 %>% 
    ...
    .$N
  HA_G9$N2[i] <- HA_G9$N[i] - Nnse$value[i]
  print(HA_G9$N2[i])
}
...
ggarrange(Fig_HAG9_N2, Fig_HAG9_N, 
          labels = c("N2", "N"),
          nrow = 2)
...
{Nnse$value[i] <- HA_G9 %>% 
  ...
  filter(tree.nr == HA_G9$tree.nr[i]) %>% 
  .$S
HA_G9$S2[i] <- HA_G9$S[i] - Nnse$value[i]
print(HA_G9$S2[i])
}
...
ggarrange(Fig_HAG9_S2, Fig_HAG9_S, 
          labels = c("S2", "S"),
          nrow = 2)

write.table(HA_G9,file="Data/Genetic Distances/HA distances/HA_G9_distances_2.txt")


########### NA !!!!!! #################

## Data import ##
NA_G9 <- read.table("Data/Genetic Distances/NA distances/NA_G9_distances.txt", header = T)
## Build redudant column ##
NA_G9 <- NA_G9[,1:5]
...
{Nnse$value[i] <- NA_G9 %>% 
  ...
  .$N
NA_G9$N2[i] <- NA_G9$N[i] - Nnse$value[i]
print(NA_G9$N2[i])
}
...
ggarrange(Fig_NAG9_N2, Fig_NAG9_N, 
          labels = c("N2", "N"),
          nrow = 2)
## S subs ##
...
{Nnse$value[i] <- NA_G9 %>% 
  ...
  filter(tree.nr == NA_G9$tree.nr[i]) %>% 
  .$S
NA_G9$S2[i] <- NA_G9$S[i] - Nnse$value[i]
print(NA_G9$S2[i])
}
...
ggarrange(Fig_NAG9_S2, Fig_NAG9_S, 
          labels = c("S2", "S"),
          nrow = 2)

write.table(NA_G9,file="Data/Genetic Distances/NA distances/NA_G9_distances_2.txt")


########### M!!!!!! #################

## Data import ##
M_G9 <- read.table("Data/Genetic Distances/M distances/M_G9_distances.txt", header = T)
## Build redudant column ##
M_G9 <- M_G9[,1:5]
...
{Nnse$value[i] <- M_G9 %>% 
  ...
  .$N
M_G9$N2[i] <- M_G9$N[i] - Nnse$value[i]
print(M_G9$N2[i])
}
...
ggarrange(Fig_MG9_N2, Fig_MG9_N, 
          labels = c("N2", "N"),
          nrow = 2)
## S subs ##
...
{Nnse$value[i] <- M_G9 %>% 
  ...
  filter(tree.nr == M_G9$tree.nr[i]) %>% 
  .$S
M_G9$S2[i] <- M_G9$S[i] - Nnse$value[i]
print(M_G9$S2[i])
}
...
ggarrange(Fig_MG9_S2, Fig_MG9_S, 
          labels = c("S2", "S"),
          nrow = 2)

write.table(M_G9,file="Data/Genetic Distances/M distances/M_G9_distances_2.txt")


########### NP!!!!!! #################

## Data import ##
NP_G9 <- read.table("Data/Genetic Distances/NP distances/NP_G9_distances.txt", header = T)
## Build redudant column ##
NP_G9 <- NP_G9[,1:5]
...
{Nnse$value[i] <- NP_G9 %>% 
  ...
  .$N
NP_G9$N2[i] <- NP_G9$N[i] - Nnse$value[i]
print(NP_G9$N2[i])
}
...
ggarrange(Fig_NPG9_N2, Fig_NPG9_N, 
          labels = c("N2", "N"),
          nrow = 2)
## S subs ##
...
{Nnse$value[i] <- NP_G9 %>% 
  ...
  filter(tree.nr == NP_G9$tree.nr[i]) %>% 
  .$S
NP_G9$S2[i] <- NP_G9$S[i] - Nnse$value[i]
print(NP_G9$S2[i])
}
...
ggarrange(Fig_NPG9_S2, Fig_NPG9_S, 
          labels = c("S2", "S"),
          nrow = 2)

write.table(NP_G9,file="Data/Genetic Distances/NP distances/NP_G9_distances_2.txt", row.names = F)
...
## Data import ##
NS_G9 <- read.table("Data/Genetic Distances/NS distances/NS_G9_distances.txt", header = T)
## Build redudant column ##
NS_G9 <- NS_G9[,1:5]
...
for (i in 1:nrow(NS_G9))
  {Nnse$value[i] <- NS_G9 %>% 
    ...
    .$N
  NS_G9$N2[i] <- NS_G9$N[i] - Nnse$value[i]
  print(NS_G9$N2[i])
}
...
ggarrange(Fig_NSG9_N2, Fig_NSG9_N, 
          labels = c("N2", "N"),
          nrow = 2)
## S subs ##
...
{Nnse$value[i] <- NS_G9 %>% 
  ...
  filter(tree.nr == NS_G9$tree.nr[i]) %>% 
  .$S
NS_G9$S2[i] <- NS_G9$S[i] - Nnse$value[i]
print(NS_G9$S2[i])
}
...
ggarrange(Fig_NSG9_S2, Fig_NSG9_S, 
          labels = c("S2", "S"),
          nrow = 2)

write.table(NS_G9,file="Data/Genetic Distances/NS distances/NS_G9_distances_2.txt")


########### PA!!!!!! #################

## Data import ##
PA_G9 <- read.table("Data/Genetic Distances/PA distances/PA_G9_distances.txt", header = T)
## Build redudant column ##
PA_G9 <- PA_G9[,1:5]
...
{Nnse$value[i] <- PA_G9 %>% 
  ...
  .$N
PA_G9$N2[i] <- PA_G9$N[i] - Nnse$value[i]
print(PA_G9$N2[i])
}
...
ggarrange(Fig_PAG9_N2, Fig_PAG9_N, 
          labels = c("N2", "N"),
          nrow = 2)
## S subs ##
...
{Nnse$value[i] <- PA_G9 %>% 
  ...
  filter(tree.nr == PA_G9$tree.nr[i]) %>% 
  .$S
PA_G9$S2[i] <- PA_G9$S[i] - Nnse$value[i]
print(PA_G9$S2[i])
}
...
ggarrange(Fig_PAG9_S2, Fig_PAG9_S, 
          labels = c("S2", "S"),
          nrow = 2)

write.table(PA_G9,file="Data/Genetic Distances/PA distances/PA_G9_distances_2.txt", row.names = F)
...
## Data import ##
PB1_G9 <- read.table("Data/Genetic Distances/PB1 distances/PB1_G9_distances.txt", header = T)
## Build redudant column ##
PB1_G9 <- PB1_G9[,1:5]
...
{Nnse$value[i] <- PB1_G9 %>% 
  ...
  .$N
PB1_G9$N2[i] <- PB1_G9$N[i] - Nnse$value[i]
print(PB1_G9$N2[i])
}
...
ggarrange(Fig_PB1G9_N2, Fig_PB1G9_N, 
          labels = c("N2", "N"),
          nrow = 2)
## S subs ##
...
{Nnse$value[i] <- PB1_G9 %>% 
  ...
  filter(tree.nr == PB1_G9$tree.nr[i]) %>% 
  .$S
PB1_G9$S2[i] <- PB1_G9$S[i] - Nnse$value[i]
print(PB1_G9$S2[i])
}
...
ggarrange(Fig_PB1G9_S2, Fig_PB1G9_S, 
          labels = c("S2", "S"),
          nrow = 2)

write.table(PB1_G9,file="Data/Genetic Distances/PB1 distances/PB1_G9_distances_2.txt", row.names = F)
...
## Data import ##
PB2_G9 <- read.table("Data/Genetic Distances/PB2 distances/PB2_G9_distances.txt", header = T)
## Build redudant column ##
PB2_G9 <- PB2_G9[,1:5]
...
{Nnse$value[i] <- PB2_G9 %>% 
  ...
  .$N
PB2_G9$N2[i] <- PB2_G9$N[i] - Nnse$value[i]
print(PB2_G9$N2[i])
}
...
ggarrange(Fig_PB2G9_N2, Fig_PB2G9_N, 
          labels = c("N2", "N"),
          nrow = 2)
## S subs ##
...
{Nnse$value[i] <- PB2_G9 %>% 
  ...
  filter(tree.nr == PB2_G9$tree.nr[i]) %>% 
  .$S
PB2_G9$S2[i] <- PB2_G9$S[i] - Nnse$value[i]
print(PB2_G9$S2[i])
}
...
ggarrange(Fig_PB2G9_S2, Fig_PB2G9_S, 
          labels = c("S2", "S"),
          nrow = 2)

write.table(PB2_G9,file="Data/Genetic Distances/PB2 distances/PB2_G9_distances_2.txt", row.names = F)
...
write.table(G9_NS,file="Data/Genetic Distances/GeneCompete/G9_NS.txt")
