...
# for PB2 #
##########
inFileNames <- c("1_PB2_Mos99_76seq.fasta", "2_PB2_Fuj02_54seq.fasta",
                 "3_PB2_Cal04_7seq.fasta", "4_PB2_Wis05_17seq.fasta",
                 "5_PB2_Bris07_51seq.fasta", "6_PB2_Prth09_54seq.fasta",
                 "7_PB2_Vic11_135seq.fasta", "8_PB2_Swtz13_25seq.fasta",
                 "9_PB2_HK15_182seq.fasta","10_PB2_Kan17_29seq.fas",
                 "11_PB2_HK19_21seq.fas","12_PB2_Cam20_25seq.fas",
                 "13_PB2_Dar21_26seq.fas")
...
####################################
for (current.vaccinePeriod in 1:13){
  
  vaccineStrain <- vaccineStrains[current.vaccinePeriod]
  #the tips to be contrasted:
  
  setwd("/1_Data/2_RNSC/3_DistanceLog/1_Before2020_601/PB2")
