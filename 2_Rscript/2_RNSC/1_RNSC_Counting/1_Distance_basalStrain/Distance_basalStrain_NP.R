...
trees <- read.beast(file = treeFiles[currentSegment.treeFile.index])
...
# for NP #
##########
inFileNames <- c("1_NP_Mos99_76seq.fasta", "2_NP_Fuj02_54seq.fasta",
                 "3_NP_Cal04_7seq.fasta", "4_NP_Wis05_17seq.fasta",
                 "5_NP_Bris07_51seq.fasta", "6_NP_Prth09_54seq.fasta",
                 "7_NP_Vic11_135seq.fasta", "8_NP_Swtz13_25seq.fasta",
                 "9_NP_HK15_182seq.fasta","10_NP_Kan17_29seq.fas",
                 "11_NP_HK19_21seq.fas","12_NP_Cam20_25seq.fas",
                 "13_NP_Dar21_26seq.fas")   ## (4) List of Fasta Files 
...
for (current.vaccinePeriod in 1:13){  ## (6) Number of vaccine period
  ...
  setwd("/1_Data/2_RNSC/3_DistanceLog/1_Before2020_601/NP")
