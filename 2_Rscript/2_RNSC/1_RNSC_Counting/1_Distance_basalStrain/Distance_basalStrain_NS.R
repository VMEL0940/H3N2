...
setwd(baseDir)
segments <- c("NS") ## (2) Name of Gene segment
segment.index <- 1
...
trees <- read.beast(file = treeFiles[currentSegment.treeFile.index])  ## Take long time to bring substree files 
nrLookedAtTrees <- length(trees)

# collect tip info in list of data frames 
vaccinePeriods <- 1:13  ## (3) Number of vaccine period
##########
# for HA #
##########
inFileNames <- c("1_NS_Mos99_76seq.fasta", "2_NS_Fuj02_54seq.fasta",
                 "3_NS_Cal04_7seq.fasta", "4_NS_Wis05_17seq.fasta",
                 "5_NS_Bris07_51seq.fasta", "6_NS_Prth09_54seq.fasta",
                 "7_NS_Vic11_135seq.fasta", "8_NS_Swtz13_25seq.fasta",
                 "9_NS_HK15_182seq.fasta","10_NS_Kan17_29seq.fas",
                 "11_NS_HK19_21seq.fas","12_NS_Cam20_25seq.fas",
                 "13_NS_Dar21_26seq.fas")   ## (4) List of Fasta Files 
vaccineStrains <- c("EPI103320_A_Moscow_10_1999", "EPI358781_A_Fujian_411_2002", "EPI367109_A_California_7_2004",
                    ...
                    "MG974447_A_Kansas_14_2017", "1592032_A_Hong_Kong_2671_2019", "1846767_A_Cambodia_E0826360_2020",
                    "2415906_A_Darwin_9_2021")  ## (5) List of Vaccine strains 
...
####################################
for (current.vaccinePeriod in 1:13){  ## (6) Number of vaccine period
  
  vaccineStrain <- vaccineStrains[current.vaccinePeriod]
  #the tips to be contrasted:
  
  setwd("/1_Data/2_RNSC/3_DistanceLog/1_Before2020_601/NS")
