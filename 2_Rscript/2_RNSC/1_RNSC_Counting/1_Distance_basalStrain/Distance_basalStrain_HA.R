...
# for HA #
##########
inFileNames <- c("1_HA_Mos99_76seq.fasta", "2_HA_Fuj02_54seq.fasta",
                 "3_HA_Cal04_7seq.fasta", "4_HA_Wis05_17seq.fasta",
                 "5_HA_Bris07_51seq.fasta", "6_HA_Prth09_54seq.fasta",
                 "7_HA_Vic11_135seq.fasta", "8_HA_Swtz13_25seq.fasta",
                 "9_HA_HK15_182seq.fasta")
...
####################################
for (current.vaccinePeriod in 1:9){
  
  vaccineStrain <- vaccineStrains[current.vaccinePeriod]
  #the tips to be contrasted:
  
  setwd("/1_Data/2_RNSC/3_DistanceLog/1_Before2020_601/HA")
